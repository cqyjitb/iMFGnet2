package yj.core.webserver_weidu.dto;

/**
 * Created by 917110140 on 2018/9/29.
 */
public class DTWEIDUReturn {
    private String MTYPE;
    private String MTMSG;
    private String WEIDUFLG;
    ...
    public void setWEIDUFLG(String WEIDUFLG) {
        this.WEIDUFLG = WEIDUFLG;
    }
    ...
    public void setZBANB(String ZBANB) {
        this.ZBANB = ZBANB;
    }

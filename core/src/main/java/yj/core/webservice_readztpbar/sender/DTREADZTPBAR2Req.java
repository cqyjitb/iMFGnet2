...
/**
 * <p>
 * Java class for DT_READZTPBAR2_Req complex type.
 *
 * <p>
 ...
 *
 * <pre>
 * &lt;complexType name="DT_READZTPBAR2_Req">
 *   &lt;complexContent>
...
@XmlType(name = "DT_READZTPBAR2_Req", propOrder = { "idata" })
public class DTREADZTPBAR2Req {

    @XmlElement(name = "I_DATA", required = true)
    protected List<DTREADZTPBAR2Req.IDATA> idata;
     ...
     * {@link DTREADZTPBAR2Req.IDATA }
     *
     *
     */
    public List<DTREADZTPBAR2Req.IDATA> getIDATA() {
        if (idata == null) {
            idata = new ArrayList<DTREADZTPBAR2Req.IDATA>();
        }
        return this.idata;
    }

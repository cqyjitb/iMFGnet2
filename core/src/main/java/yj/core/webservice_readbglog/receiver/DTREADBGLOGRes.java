...
public class DTREADBGLOGRes {
    ...
    protected List<DTREADBGLOGRes.DETAIL> detail;
     ...
     *
     */
    public List<DTREADBGLOGRes.DETAIL> getDETAIL() {
        if (detail == null) {
            detail = new ArrayList<DTREADBGLOGRes.DETAIL>();
        }
        return this.detail;
    }
    ...
    public static class DETAIL {
        ...
        protected List<DTREADBGLOGRes.DETAIL.MAKT> makt;
        @XmlElement(name = "AFVC")
        protected List<DTREADBGLOGRes.DETAIL.AFVC> afvc;
         ...
         *
         */
        public List<DTREADBGLOGRes.DETAIL.MAKT> getMAKT() {
            if (makt == null) {
                makt = new ArrayList<DTREADBGLOGRes.DETAIL.MAKT>();
            }
            return this.makt;
        }
         ...
         *
         */
        public List<DTREADBGLOGRes.DETAIL.AFVC> getAFVC() {
            if (afvc == null) {
                afvc = new ArrayList<DTREADBGLOGRes.DETAIL.AFVC>();
            }
            return this.afvc;
        }

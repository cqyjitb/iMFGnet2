...
public class DTBAOGONGSendRes {
    ...
    protected List<DTBAOGONGSendRes.DETAIL> detail;
     ...
     *
     */
    public List<DTBAOGONGSendRes.DETAIL> getDETAIL() {
        if (detail == null) {
            detail = new ArrayList<DTBAOGONGSendRes.DETAIL>();
        }
        return this.detail;
    }
    ...
    public static class DETAIL {
        ...
        protected List<DTBAOGONGSendRes.DETAIL.AFVC> afvc;
         ...
         *
         */
        public List<DTBAOGONGSendRes.DETAIL.MAKT> getMAKT() {
            if (makt == null) {
                makt = new ArrayList<DTBAOGONGSendRes.DETAIL.MAKT>();
            }
            return this.makt;
        }
         ...
         *
         */
        public List<DTBAOGONGSendRes.DETAIL.AFVC> getAFVC() {
            if (afvc == null) {
                afvc = new ArrayList<DTBAOGONGSendRes.DETAIL.AFVC>();
            }
            return this.afvc;
        }
